...
$barangMasuk = queryStockBarang("SELECT * FROM masuk");
...
<head>
    ...
    <title>Gudang Barang - Barang Masuk</title>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="idbarang" aria-label="Default select example">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="quantity" id="quantity" placeholder="Masukkan jumlah stock" required>
                    </div>
                    <div class="mb-3">
                        <label for="penerima" class="form-label">Penerima</label>
                        <input type="text" class="form-control" name="penerima" id="penerima" placeholder="Masukkan penerima" required>
                    </div>
